...
class App extends Component {
	...
	componentDidMount() {
		axios.get("https://joseapi.herokuapp.com/series/").then((res) => {
	...
	mostrar(cod, index) {
		axios.get("https://joseapi.herokuapp.com/series/" + cod).then((res) => {
			this.setState({
				pos: index,
				titulo: "Editar",
				id: res.data.id,
	...
	guardar(e) {
		...
		if (cod > 0) {
			...
			axios
				.put("https://joseapi.herokuapp.com/series/" + cod, datos)
				.then((res) => {
			...
			//nuevo registro
			axios
				.post("https://joseapi.herokuapp.com/series/", datos)
				.then((res) => {
	...
	eliminar(cod) {
		...
		if (rpta) {
			axios
				.delete("https://joseapi.herokuapp.com/series/" + cod)
				.then((res) => {
								...
								return (
									<tr key={serie.id}>
										...
										<td>
											...
											<Button
												variant="danger"
												onClick={() => this.eliminar(serie.id, index)}>
												eliminar
											</Button>
										</td>
									</tr>
